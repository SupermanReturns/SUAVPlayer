...
+ (instancetype)initilzerProgressViewWithFrame:(CGRect)frame {
    SPlayerProgressView *progressView = [[SPlayerProgressView alloc] initWithFrame:frame];
    progressView.continuous = YES;
    [progressView setMinimumValue:0.0];
    [progressView setMaximumValue:1.0];
    
    progressView.value = 0.0;
    [progressView setThumbImage:[UIImage imageNamed:SVideoName(@"player-kit-slider_indicator")] forState:UIControlStateNormal];
    [progressView setMinimumTrackImage:[UIImage imageNamed:SVideoName(@"player-kit-slider_track_fill")] forState:UIControlStateNormal];
    
    [progressView setMaximumTrackImage: [UIImage imageNamed:SVideoName(@"player-kit-slider_track_empty")] forState:UIControlStateNormal];
    return progressView;
}
